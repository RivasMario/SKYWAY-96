...
| Screw holes | 11 × **Ø4.0** (M2 + washer); 1 capped to Ø2.85 (PCB-constrained), aligned to PCB mounting holes |
...
**Changes from PCB-exact:** screw holes opened Ø2.4→**Ø4.0** and notches grown
...
switches there. Holes are sized **per-hole**: as big as Ø4.0 while keeping a
≥0.3 mm wall to the nearest switch cutout — one PCB-constrained hole is therefore
capped at Ø2.85. **Holes >3.8 mm need a washer** (M2 head is ~3.8 mm) — that's 10 of 11 here. Regenerate via `scripts/postprocess_plate.py --screw-dia ... --min-wall ...`.
